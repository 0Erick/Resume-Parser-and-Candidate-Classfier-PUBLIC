...
cE = documentClient["Your_Deployment"]["embedded"] # Cambiar Your_Deployment por el nombre de la base de datos
...
tracker_db = tracker_client["Your_Deployment"]["tracker"] # Cambiar Your_Deployment por el nombre de la base de datos
